...
export default function Website() {
  ...
  const macDownload = "https://github.com/ljt1024/LShell/releases/latest/download/LShell-0.1.0-arm64.dmg";
  const windowsDownload = "https://github.com/ljt1024/LShell/releases/latest/download/LShell-Setup-0.1.0.exe";
  ...
  return <main className="moe-site">
    ...
    <section className="download-section" id="download">
      ...
      <small>当前版本 v0.1.0 · 安装包由 GitHub Releases 提供</small>
    </section>
